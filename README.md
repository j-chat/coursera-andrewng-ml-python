...
* coursera_andrewng_machinelearning_ex7: uses K-means to compress the image of a bird. This clustering problem reduces the number of colors to the top 16. 
* coursera_andrewng_machinelearning_ex7_pca: uses PCA to reduce the dimensions of a faces image dataset. This dimensionality reduction problem reduces the dimensions from 1024 to 100.
